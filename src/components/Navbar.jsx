...
const links = [
    {
        ...
        label: 'Dashboard',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" style={{ width: 16, height: 16 }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
                ...
                {onClose && (
                    <button
                        ...
                        style={{
                            ...
                            padding: '0.25rem', color: 'var(--color-neutral-400)',
